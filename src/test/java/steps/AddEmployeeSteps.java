...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enters_firstname_and_middlename_and_lastname_and_verify_employee_has_been_added
        ...
        for (Map<String, String> employee : employeeNames) {
            ...
            //filling the names in the field
    ...
    public void user_adds_multiple_employees_using_excel_from_and_verify_it(String sheetName) throws InterruptedException {
        ...
        while (itr.hasNext()) {
            //in this we have data for every single employee one by one it will give us that data
            Map<String, String> mapNewEmp = itr.next();
            //we are filling the data now using mapNewEmp variable
            //KEYS WE ARE PASSING HERE SHOULD MATCH WITH THE KEYS IN EXCEL
            ...
            for (int i = 0; i < rowData.size(); i++) {
                ...
                //output of this will be empId space firstname space middlename space lastname
                ...
                //you can use be,oew code too to verify the data
                //Assert.assertTrue(rowText.equals(rowText));
            }
