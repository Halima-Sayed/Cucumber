...
Feature: Adding employee in HRMS application
  ...
  Scenario: adding one employee
    #we can use * instead of when and then when but tags are preferred
    ...
    Scenario: Adding one employee from feature file
      ...
      Scenario Outline: adding multiple employees using scenario outline
        #in cucumber we represent the key is in angular form < > and without < > it will be considered as value
        ...
        @datatable
        Scenario: adding multiple employees using data tables
